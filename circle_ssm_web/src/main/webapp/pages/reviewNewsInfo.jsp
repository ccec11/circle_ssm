                ...
                <div class="box-body">
                    ...
                    <div class="table-box">
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tbody>
                        <c:forEach items="${allNewsInfo}" var="newsInfo">
                            <tr>
                                <td><input name="ids" type="checkbox"></td>
                                <td>${newsInfo.newsId}</td>
                                <td><u>${newsInfo.newsTitle}</u></td>
                                <td>${newsInfo.labelInfo.labelName}</td>
                                <td>10%</td>
